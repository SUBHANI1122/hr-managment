            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label for="" class="form-label">Assign Country</label>
                            <select class="form-control" id="country_id" name="country_id[]" multiple>
                                @foreach(App\Country::all() as $country)
                                    <option value="{{$country->id}}" {{ isset($role, $role->id) && in_array($country->id, $child_arr)  ? 'selected' : ''}}>{{$country->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
