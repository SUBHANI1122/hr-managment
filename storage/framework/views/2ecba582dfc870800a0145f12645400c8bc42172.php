        ...
        <div class="table-responsive">
            <table id="pay_list-table" class="table">
                ...
                <tr>
                    ...
                    <th><?php echo e(__('OverTime Amount')); ?></th>
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="payment_amount" id="total_salary_payment" class="form-control" >
                                    </div>
                                </div>
...
<script type="text/javascript">
    (function($) {
        ...
        $('#payment_form').on('submit', function(event) {
           ...
           let month_year = $('#hidden_month_year').val($('#month_year').val());
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        let target = '<?php echo e(route('paySlip.email')); ?>' ;
                        var month_year = $("#month_year").val();
                        $.ajax({
                            url: target,
                            method: "POST",
                            data : {employee_id : id, month_year:month_year, type:'single'},
                            success: function (data) {
                                console.log(data);
                            }
                        });
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        $.ajax({
                            url: target,
                            method: "POST",
                            data : {all_checkbox_id : allCheckboxId, month_year:month_year, type:'bulk'},
                            success: function (data) {
                                console.log(data);
                            }
                        });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\convextech-hrms\resources\views/salary/pay_list/index.blade.php ENDPATH**/ ?>