...
<div id="employee_profile_photo">
    <?php if($employee->user->profile_photo): ?>
        <div><img src="<?php echo e(url('uploads/profile_photos',$employee->user->profile_photo)); ?>" height="100"
                  width="100">
        </div>
    <?php else: ?>
        <div><img src="<?php echo e(url('logo/avatar.jpg')); ?>" height="100" width="100">
        </div>
    <?php endif; ?>
</div>
...
</form><?php /**PATH D:\xampp\htdocs\convextech-hrms\resources\views/employee/profile_picture/index.blade.php ENDPATH**/ ?>