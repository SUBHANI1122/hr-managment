            ...
            <script>
                (function($) {
                    ...
                    $('#leave_sample_form').on('submit', function (event) {
                        ...
                        if( $('#leave_is_half').is(':checked') ){
                            $('#diff_date_hidden').val(dayDiff-.5);
                        }
                        else{
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\convextech-hrms\resources\views/dashboard/employee_dashboard.blade.php ENDPATH**/ ?>