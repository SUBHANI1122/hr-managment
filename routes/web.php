...
Route::group(['middleware' => ['XSS']], function ()
{
	...
	Route::prefix('organization')->group(function ()
	{
...

		{
			...
			Route::post('announcements/email', 'AnnouncementController@announcement_email')->name('announcements.email');
		}
	...
	Route::prefix('payroll')->group(function ()
	{
		...
		Route::post('payslip/payment/email', 'PayrollController@PayamentEmail')->name('paySlip.email');
